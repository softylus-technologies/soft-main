  ...
  return (
    <section className='SoftylusAILaunchpad-sec'>
      <div className='SoftylusAILaunchpad-container'>
        ...
        <Link to="" className='no-underline inline-flex items-center justify-center text-base font-bold text-main bg-white hover:opacity-85 border-0 rounded-full focus:ring-10'>

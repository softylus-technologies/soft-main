...
const SliderButtons = () => {
  ...
  return (
    <div className="btn-sliider">
      ...
      >
        <img src='/Frame 1000003367.png' alt="Previous slide arrow" />
      </button>
      <button
      ...
      >
        <img src='/Frame 1000003367.png' alt="Next slide arrow" />
      </button>
    </div>
  );
};
...
const ProjectDetail = ({ params, location }) => {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      ...
      try {
        const url = `https://strapi.softylus.com/api/projects?filters[slug][$eq]=${slug}&locale=en&populate=images,TechnologyUsed`;
  ...
  return (
    <Layout>
      <Seo
        ...
        description={`Explore the details of ${description}`}
      />

...
function ContactForm() {
  ...
  useEffect(() => {
    const fetchTestimonials = async () => {
      try {
        const response = await axios.get(`https://strapi.softylus.com/api/testimonials?locale=ar&populate=picture`, {
          headers: {
            "Accept": "*/*",
            "Content-Type": "application/json",
            "Authorization": "Bearer "
  ...
  return (
    <Layout>
      <Seo 
        title="تواصل معنا | اتصل بSoftylus"
        description="هل أنت جاهز لبدء رحلة تطوير البرمجيات؟ اتصل بSoftylus  اليوم لمناقشة احتياجات مشروعك ومعرفة كيف يمكننا المساعدة في رفع مستوى عملك"
      />

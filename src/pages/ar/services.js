...
const Services = () => {
  ...
  return ( 
    <Layout>
      <Helmet>
        <title>حلول برمجية شاملة | خدمات Softylus</title>
        <meta name="description" content="استكشف مجموعتنا الكاملة من الخدمات بما في ذلك تطوير الويب والهواتف المحمولة وتصميم UI/UX والمزيد. تكرس شركة Softylus جهودها لتقديم حلول مخصصة تلبي احتياجات عملك المحددة." />

...
const Careers = () => {
  ...
  return (
      <Layout>
        <Seo
          title="الفرص الوظيفية | Softylus Technologies"
          description="استكشف الفرص الوظيفية المثيرة في Softylus Technologies. انضم إلى فريقنا واعمل على مشاريع مثيرة للاهتمام في مجال التكنولوجيا والابتكار"
        />
        <Header
